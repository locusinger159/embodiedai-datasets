...
// Copy embeddings.json if exists (generated by scripts/embed.js)
const embFile = 'dist/embeddings.json';
if (fs.existsSync(embFile)) {
  console.log('  embeddings.json found (' + (fs.statSync(embFile).size / 1024).toFixed(1) + ' KB)');
}
