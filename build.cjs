...
const UI = {
  zh: {
    ...
    taskLabels: { '操作': '操作', '抓取': '抓取', '导航': '导航', '装配': '装配', '家居': '家居', '交互': '交互', '运动控制': '运动控制', '可供性分割': '可供性分割', '3D运动预测': '3D运动预测', '接触点预测': '接触点预测', '人机交互': '人机交互', '物体交互': '物体交互', '3D场景理解': '3D场景理解', '语义分割': '语义分割', '语言推理': '语言推理', '康养护理': '康养护理', '人类操作': '人类操作' },
  ...
  en: {
    ...
    taskLabels: { '操作': 'Manipulation', '抓取': 'Grasping', '导航': 'Navigation', '装配': 'Assembly', '家居': 'Household', '交互': 'Interaction', '运动控制': 'Locomotion', '可供性分割': 'Affordance Seg.', '3D运动预测': '3D Motion', '接触点预测': 'Contact Pred.', '人机交互': 'HOI', '物体交互': 'Object Interact.', '3D场景理解': '3D Understanding', '语义分割': 'Segmentation', '语言推理': 'Lang. Reasoning', '康养护理': 'Healthcare', '人类操作': 'Human Activity' },
