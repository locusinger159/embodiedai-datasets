...
- **数据标准页** — 28 个行业标准/评测基准，每条含 RFC 2119 规范性要求（MUST/SHOULD/MAY），表格/卡片双视图
...
- 🧠 **论文知识库** — 137 篇数据集论文全文嵌入，AI 助手升级为 Expert Agent。支持方法论级问答（「π0 用什么架构？」「ALOHA 动作空间多大？」），知识壁垒：fork 站拿不到论文库
