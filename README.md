...
- 📊 收录 **96** 个数据集
- 📐 收录 **22** 个数据标准与评测基准
- 🏆 **5 个 Benchmark 排行榜**（LIBERO / CALVIN / SimplerEnv / RLBench / FurnitureBench）
- 🔧 收录 **18** 个工具与平台
...
- **Benchmark 排行榜** — 🏆 5 个标准 benchmark 独立排行榜（LIBERO / CALVIN / SimplerEnv / RLBench / FurnitureBench），论文数据可溯源
...
- **数据标准页** — 22 个行业标准/评测基准，每条含 RFC 2119 规范性要求（MUST/SHOULD/MAY），表格/卡片双视图
