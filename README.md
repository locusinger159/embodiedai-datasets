...
- **技术博客** — 5 篇深度文章：7 天 VLA 项目实战 / AI 搜索技术实践 / GR-1 数据生态测评 / UniACT 深度解析
...
├── docs/data/
│   ├── datasets.json / datasets.en.json       # 59 个数据集
...
- 💻 **全部数据集快速上手** — 58 个数据集补充 `usage` 字段（加载代码/依赖库/预处理说明），`dataFormat` 扩展 layout/index/format
