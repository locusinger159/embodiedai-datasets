...
- **标准草案** — 基于 55 个数据集分析提出的统一数据格式建议，社区讨论驱动
...
1. `node build.cjs` — 读取 JSON，注入模板，生成 58 个详情页 + 4 个列表页
...
### 数据翻译
- [ ] 58 个数据集的 `description`、`notes`、`quality` 等文本字段翻译为英文
