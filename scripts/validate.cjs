...
const VALID_MODALITIES = ['视觉', '深度', '触觉', '本体状态', '动作', '音频', '文本', '力觉', '力矩', 'LiDAR', 'IMU', '眼动追踪', '表面肌电', 'RGB', '点云', '3D点云', '3D重建', '力控', '语言', '语义分割', '多视角视觉', '仿真状态', '3D手部网格', '3D物体网格', '接触标注', '3D手部姿态', '6-DoF腕部姿态', 'GNSS'];
