...
const VALID_TASKS = ['操作', '抓取', '导航', '装配', '家居', '交互', '运动控制', '可供性分割', '3D运动预测', '接触点预测', '人机交互', '物体交互', '3D场景理解', '语义分割', '语言推理', '康养护理', '人类操作', '动作捕捉'];
const VALID_MODALITIES = ['视觉', '深度', '触觉', '本体状态', '动作', '音频', '文本', '力觉', '力矩', 'LiDAR', 'IMU', '眼动追踪', '表面肌电', 'RGB', '点云', '3D点云', '3D重建', '力控', '语言', '语义分割', '多视角视觉', '仿真状态', '3D手部网格', '3D物体网格', '接触标注', '3D手部姿态', '6-DoF腕部姿态', 'GNSS', '3D模型', '物理参数', '材质'];
